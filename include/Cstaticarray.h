...
template <typename T, unsigned int N>
void
Cstaticarray<T, N>::remove(unsigned int index)
{
...
template <typename T, unsigned int N>
void
Cstaticarray<T, N>::insert(const T& t, unsigned int index)
{
...
template <typename T, unsigned int N>
T*
Cstaticarray<T, N>::split(unsigned int index)
{
  T* t;
