...
template <typename U, typename T>
void
Cset<U, T>::remove(unsigned int index)
{
  T::remove(index);
}
...
template <typename U, typename T>
void
Cset<U, T>::insert(const U& u, unsigned int index)
{
  T::insert(u, index);
}
...
template <typename U, typename T>
bool
Cset<U, T>::issubset(const Cset& set) const
{
  bool isequal;
...
template <typename U, typename T>
bool
Cset<U, T>::equal(const Cset& set) const
{
