...
template <typename T>
void
Ccirsinglylinklist<T>::deJoint(T* t, unsigned int direction)
{
...
template <typename T>
void
Ccirsinglylinklist<T>::Joint(T* t1, T* t2, unsigned int direct)
{
  if (Ccirsinglylinklist<T>::isEmpty())
    return;
...
template <typename T>
T&
Ccirsinglylinklist<T>::Insert(T* t, unsigned int index)
{
...
template <typename T>
T&
Ccirsinglylinklist<T>::Insert(unsigned int index)
{
...
template <typename T>
void
Ccirsinglylinklist<T>::Remove(T* t)
{
  deJoint(Ccirsinglylinklist<T>::tail[0], direction);
...
template <typename T>
void
Ccirsinglylinklist<T>::Remove(unsigned int index)
{
  deJoint(Ccirsinglylinklist<T>::tail[0], direction);
...
template <typename T>
T*
Ccirsinglylinklist<T>::Split(T* t)
{
  deJoint(Ccirsinglylinklist<T>::tail[0], direction);
...
template <typename T>
T*
Ccirsinglylinklist<T>::Split(unsigned int index)
{
  T* t;
  deJoint(Ccirsinglylinklist<T>::tail[0], direction);
...
template <typename T>
T&
Ccirsinglylinklist<T>::getNode(unsigned int index) const
{
  T* temp1;
  unsigned int i;
...
template <typename T>
unsigned int
Ccirsinglylinklist<T>::getIndex(const T* t) const
{
  T* temp1;
  unsigned int i;
...
template <typename T>
unsigned int
Ccirsinglylinklist<T>::countNode() const
{
  T* temp1;
  unsigned int i;
...
template <typename T>
void
Ccirdoublylinklist<T>::deJoint(T* t, unsigned int direction)
{
...
template <typename T>
void
Ccirdoublylinklist<T>::Joint(T* t1, T* t2, unsigned int direct)
{
  if (Ccirdoublylinklist<T>::isEmpty())
    return;
...
template <typename T>
T&
Ccirdoublylinklist<T>::Insert(T* t, unsigned int index)
{
  deJoint(Ccirdoublylinklist<T>::tail[NEXT], NEXT);
  deJoint(Ccirdoublylinklist<T>::head[PREV], PREV);
...
template <typename T>
T&
Ccirdoublylinklist<T>::Insert(unsigned int index)
{
  return Insert(new T, index);
}
...
template <typename T>
void
Ccirdoublylinklist<T>::Remove(T* t)
{
  deJoint(Ccirdoublylinklist<T>::tail[NEXT], NEXT);
  deJoint(Ccirdoublylinklist<T>::head[PREV], PREV);
...
template <typename T>
void
Ccirdoublylinklist<T>::Remove(unsigned int index)
{
  deJoint(Ccirdoublylinklist<T>::tail[NEXT], NEXT);
  deJoint(Ccirdoublylinklist<T>::head[PREV], PREV);
...
template <typename T>
T*
Ccirdoublylinklist<T>::Split(T* t)
{
  deJoint(Ccirdoublylinklist<T>::tail[NEXT], NEXT);
  deJoint(Ccirdoublylinklist<T>::head[PREV], PREV);
...
template <typename T>
T*
Ccirdoublylinklist<T>::Split(unsigned int index)
{
  T* t;
...
template <typename T>
T&
Ccirdoublylinklist<T>::getNode(unsigned int index) const
{
  T* temp1;
  unsigned int i;
...
template <typename T>
unsigned int
Ccirdoublylinklist<T>::getIndex(const T* t) const
{
  T* temp1;
  unsigned int i;
...
template <typename T>
unsigned int
Ccirdoublylinklist<T>::countNode() const
{
  T* temp1;
  unsigned int i;
